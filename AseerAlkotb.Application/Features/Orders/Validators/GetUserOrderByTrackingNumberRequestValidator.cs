...
{
    public class GetUserOrderByTrackingNumberRequestValidator : AbstractValidator<GetUserOrderByTrackingNumberRequest>
    {
        public GetUserOrderByTrackingNumberRequestValidator()
        {
